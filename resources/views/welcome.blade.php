...
@section('content')
    ...
    <section class="hero" data-aos="fade-in">
        <div class="hero-content">
            ...
            <a href="/shop" class="btn action-link">Shop Now</a>
        </div>
    </section>
    ...
    <section class="ai-finder" data-aos="zoom-in">
        ...
        <form id="searchForm" action="{{ route('ai.finder') }}" method="POST" enctype="multipart/form-data" class="mt-4">
            @csrf
                    ...
                    <div class="col-md-4" data-aos="fade-up" data-aos-delay="{{ $loop->index * 100 }}">
                        <div class="product-card">
                            ...
                            <div class="p-3">
                                ...
                                <a href="/product/{{ $product->id }}" class="btn btn-sm btn-warning mt-2 action-link">View
                                    Details</a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row g-4 justify-content-center">
                    ...
                    <div class="col-md-4" data-aos="fade-up" data-aos-delay="{{ $loop->index * 100 }}">
                        <div class="testimonial-card text-center">
                            <div class="d-flex justify-content-center mb-3">
                                <i class="bi bi-person-circle" style="font-size: 70px; color: #f4b400;"></i>
                            </div>
                ...
                @empty
                    <div class="col-12 text-center">
                        <p class="text-muted">No reviews yet. Be the first to leave feedback after your order!</p>
                    </div>
                @endforelse
            </div>
        </div>
    ...
    <section class="sale-section" data-aos="zoom-in">
        <h2>World Best Tiles</h2>
        <p>Sale Ends Very Soon</p>
        <a href="/shop" class="btn action-link">Order Now</a>
    </section>

    <!-- MODAL -->
    <div class="modal fade" id="aiResultsModal" tabindex="-1" aria-labelledby="aiResultsLabel" aria-hidden="true">
        <div class="modal-dialog modal-xl modal-dialog-centered">
            <div class="modal-content" style="border-radius: 15px;">
                <div class="modal-header">
                    <h5 class="modal-title" id="aiResultsLabel">AI Product Match Results</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                </div>
                <div class="modal-body" id="aiResultsContent">
                    <div class="text-center text-muted py-5">Processing your request...</div>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        document.getElementById('searchForm').addEventListener('submit', function (e) {
            ...
            fetch(form.action, {
                ...
                .then(data => {
                    ...
                    document.getElementById('aiResultsContent').innerHTML = data.html;
        ...
        // Apply loader to all links with .action-link
