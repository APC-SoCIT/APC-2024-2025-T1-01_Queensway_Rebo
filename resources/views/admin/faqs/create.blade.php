...
<div class="container-fluid px-4 py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="fw-semibold text-gray-800 mb-0">❓ Add New FAQ</h2>
            ...
            <form method="POST" action="{{ route('admin.faqs.store') }}">
                ...
                <div class="row g-4">
                    ...
                    <div class="col-12">
                        ...
                        <input type="text" class="form-control shadow-sm" id="question" name="question"
                    ...
                    <div class="col-12">
                        ...
                        <textarea class="form-control shadow-sm" id="answer" name="answer" rows="4"
                    ...
                    <div class="col-12">
                        ...
                        <input type="text" class="form-control shadow-sm" id="keywords" name="keywords"
                            placeholder="e.g., payment, refund, delivery" required>
                    </div>
                </div>

                <div class="d-flex justify-content-end mt-4">
                    <button type="submit" class="btn btn-indigo px-4 d-flex align-items-center gap-2">
                        <i class="fas fa-save"></i> <span>Save FAQ</span>
                    </button>
                </div>
            </form>
        </div>
...
<style>
/* ===== Modern Theme (matches Add Product page) ===== */
