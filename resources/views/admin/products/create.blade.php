...
<div class="container-fluid px-4 py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="fw-semibold text-gray-800 mb-0">🛍️ Add New Product</h2>
            ...
            <form method="POST" action="{{ route('admin.products.store') }}" enctype="multipart/form-data">
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control shadow-sm" id="name" name="name" placeholder="Enter product name" required>
                    </div>

                    <!-- Price -->
                    <div class="col-md-3">
                        <label for="price" class="form-label fw-semibold text-gray-700">Price (₱)</label>
                        <input type="number" step="0.01" class="form-control shadow-sm" id="price" name="price" placeholder="0.00" required>
                    </div>

                    <!-- Quantity -->
                    <div class="col-md-3">
                        <label for="quantity" class="form-label fw-semibold text-gray-700">Quantity</label>
                        <input type="number" class="form-control shadow-sm" id="quantity" name="quantity" placeholder="0" required>
                    </div>
                    ...
                    <div class="col-12">
                        ...
                        <textarea class="form-control shadow-sm" id="description" name="description" rows="4" placeholder="Enter product details..."></textarea>
                    </div>
                </div>
