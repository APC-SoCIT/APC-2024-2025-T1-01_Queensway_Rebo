...
@section('content')
    ...
    <section class="product-section" data-aos="fade-up">
        <div class="row align-items-center g-5">
            ...
            <div class="col-md-6">
                ...
                @if($product->quantity > 0)
                    <form action="{{ route('cart.add') }}" method="POST" class="mt-4 loader-form">
                        @csrf
                        ...
                        @auth
                            ...
                            <a href="{{ route('checkout') }}" class="btn-buy loader-link">Buy Now</a>
                        @else
    ...
    <section class="calculator-section" data-aos="fade-up">
        ...
        <form class="row justify-content-center g-3" id="tile-calculator">
            ...
            <div class="col-md-5">
                ...
                <input type="number" step="0.1" id="tile_length" class="form-control" value="{{ $product->length ?? '' }}"
                    required>
            </div>
            <div class="col-md-5">
                ...
                @foreach($relatedProducts as $related)
                    <div class="col-md-3">
                        <div class="card border-0 shadow-sm rounded-4 overflow-hidden h-100 text-center">
                            <img src="/storage/{{ $related->image }}" alt="{{ $related->name }}" class="img-fluid"
                            ...
                            <div class="p-3">
                                ...
                                <a href="/product/{{ $related->id }}" class="btn view-btn loader-link">View Details</a>
                            </div>
                        </div>
                    </div>
                @endforeach
    ...
    <script>
        ...
        document.querySelectorAll('.loader-form').forEach(form => {
            form.addEventListener('submit', () => showGlobalLoader());
        });

        document.querySelectorAll('.loader-link').forEach(link => {
            link.addEventListener('click', () => showGlobalLoader());
        });
