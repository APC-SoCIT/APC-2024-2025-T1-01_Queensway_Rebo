    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            <!-- ... Your content goes here ... -->
                <?php 
                    $prodID=$_POST['PNAME'];
                    $result = mysqli_query($dbconn ,"SELECT * FROM products WHERE id = '". $prodID . "' LIMIT 1");
                    ...
                    <div class='col-lg-6'>
                        <form role='form' action='editproductprocess.php' method='post'>
                            <div class='form-group'>
                                ...
                                <input type='number' class='form-control'  name='editID' id='editID' maxlength='6' value=".$row['id']." required readonly>
                            </div>
                            <div class='form-group'>
